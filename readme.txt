This script only works with Siemens dicom MRSI and Dixon MRI data acquired with parameters enlisted in the paper.
...
Prerequisite functions are: - read_ascconv_lenk.m 
